      ...
      @forelse ($data as $item)
        <div class="col mb-2 text-center">
            <div class="d-inline-block position-relative">
                ...
                <a href="{{route('proyek.redo', $item->id)}}" title="Kembalikan proyek" onclick="return confirm('Apa anda yakin menyimpan proyek ini?')"  class=" bg-primary text-white rounded-circle position-absolute" style="bottom: 0; right: 0;">

    ...
    <div class="row d-flex">
        <div class="col-md-2">
                ...
                <div class="nav flex-row nav-pills" id="v-pills-tab" role="tablist" aria-orientation="horizontal">
                    @foreach ($data->SoalDetail as $item)
        ...
        <div class="col-md-10">
            ...
            <div class="tab-content" id="v-pills-tabContent">
                @foreach ($data->SoalDetail as $key => $item)
                                                    ...
                                                    <div class="row d-flex stimulus-container mb-2">
                                                        ...
                                                        <div class="col-md stimulus-tipe">
                                                            ...
                                                            @if ($stimulus['tipe'] == 'teks')
                                                                <textarea name="{{$key+1}}_stimulus[]" class="form-control mb-2" cols="3" rows="3" required>{{$stimulus['value']}}</textarea>
                                                            @else
                                                            <li>
                                                ...
                                                @foreach ($item->opsi_jawaban as $j => $jawaban)
                                                    <div class="opsi-remove mb-3 d-flex align-items-center justify-content-center">
                                                        ...
                                                        <div class="col-md ms-3">
                                                            <input type="radio" value="{{$j+1}}"  name="{{$key+1}}_kunci_jawaban[]" class="kunci-jawaban-value" required />
                                                        </div>
                                                    </div>
                                                @endforeach
                                            </div>
